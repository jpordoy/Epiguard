...
val PrimaryBlue = Color(0xFF4552CB)
val PrimaryDark = Color(0xFF070821)
val LightGray = Color(0xFFBBC3CE)
val BackgroundGray = Color(0xFFF0F0F8)
val BorderGray = Color(0xFFE4E3F3)
val LightBackground = Color(0xFFF8F7FB)
val White = Color(0xFFFFFFFF)
val TextSecondary = Color(0xFFBBC3CE)
